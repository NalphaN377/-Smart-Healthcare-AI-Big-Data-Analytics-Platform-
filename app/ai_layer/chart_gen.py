...
def build_bar_option(data: dict, value_field: str = None) -> dict:
    ...
    return {
        ...
        "grid": {"left": 40, "right": 20, "bottom": 80, "top": 50},
        "xAxis": {
            "type": "category", "data": categories,
            "axisLabel": {"rotate": 30, "interval": 0},
        },
        "yAxis": {"type": "value"},
        "series": [{"name": METRIC_LABELS.get(value_field, value_field), "type": "bar", "data": values}],
    }
...
def build_pie_option(data: dict, value_field: str = None) -> dict:
    ...
    return {
        ...
        "series": [{"name": dim_label, "type": "pie", "radius": "55%", "data": pie_data}],
    }
...
def build_line_option(data: dict, value_field: str = None) -> dict:
    ...
    return {
        ...
        "yAxis": {"type": "value"},
        "series": [{"name": METRIC_LABELS.get(value_field, value_field), "type": "line", "data": values}],
    }
