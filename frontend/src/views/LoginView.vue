...
<template>
  <main class="login-page">
    <section class="login-brand"><div class="login-logo-row"><div class="logo"><i></i><i></i></div><strong>智医数析</strong></div><p>SMART HEALTHCARE PLATFORM</p><h1>让医疗数据<br><span>成为可靠洞察</span></h1><small>智慧医疗大数据与 AI 分析平台</small></section>
